...
// interface VARIBALES{
//   handle:string,id: string; descreption: string, vendor:string,title:string,totalInventory:number,tracksInventory:number,max_amount:string,currencyCode:string,min_amount:string
// }
