      ...
      return json<ActionData>({
        ...
        comparison: {
          ...
          after: {
            ...
            width: newMedia.image?.width,
            height: newMedia.image?.height,
            format: "WebP",
          },
        },
      });
      ...
      return json<ActionData>({
        ...
        comparison: {
          ...
          after: {
            ...
            width: updatedVariant?.image?.width || newMediaImage?.width,
            height: updatedVariant?.image?.height || newMediaImage?.height,
            format: "WebP",
          },
        },
      });
        ...
        >
          ...
          >
            ...
            >
              ...
              <img
                src={
                  actionData?.comparison?.before.url ||
                  lastComparison?.before.url
                }
                alt="Before"
                style={{
                  width: "100%",
              ...
              <div style={{ fontSize: "0.85rem", fontWeight: 600, color: "#333" }}>
                {(() => {
                  const data = actionData?.comparison?.before || lastComparison?.before;
                  return data?.format || "Original";
                })()}
              </div>
            ...
            >
              ...
              <img
                src={
                  actionData?.comparison?.after.url ||
                  lastComparison?.after.url
                }
                alt="After"
                style={{
                  width: "100%",
              ...
              <div style={{ fontSize: "0.85rem", fontWeight: 600, color: "#333" }}>
                {(() => {
                  const data = actionData?.comparison?.after || lastComparison?.after;
